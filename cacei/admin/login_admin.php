...
?>
    ...
    <body class="text-center">
        ...
        <form class="form-signin" id="loginForm" style="background-color: white;border-radius: 15px;">
            ...
            <h1 class="h3 mb-3 font-weight-normal" style="color: black">Iniciar sesion administrador</h1>
            <label for="inputEmail" class="sr-only">Usuario</label>
            <input type="text" id="admin" name="admin" class="form-control" placeholder="Ingrese su nombre de usuario" required autofocus>
            <br />
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                $("#loginForm").validate({
                    ...
                    messages: {
                        admin: {
                            required: "Ingrese su código de administrador"
                        },
                        inputPassword: {
                    ...
                    submitHandler: function(form) {
                        $.ajax({
                            ...
                            url: "acceder_admin.php",
                            //Definimos el tipo de método de envío
                            type: "POST",
                            //Definimos el tipo de datos que vamos a enviar y recibir
                            dataType: "HTML",
                            //Definimos la información que vamos a enviar
                            data: "admin=" + $("#admin").val() + "&inputPassword=" + $("#inputPassword").val()
                        }).done(function(echo) {
                            if (echo == '1') {
