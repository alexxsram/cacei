...
try {
 ...
 if ($num != 0) {
	...
	<tr>
		...
		<td colspan="4"><b>Secci&oacute;n: '. $_GET['seccion'].' </b></td>
	...
	C= es indisciplinado  o distra&iacute;do</b>
				...
				$html.='<tr><td colspan ="5" align="center">'. $detalle->alumno .'</td>';
					$html.='<td colspan ="2" align="center">'. $detalle->situacion.'</td>';
					$html.='<td colspan ="4" align="center">'. $detalle->comentario.'</td> </tr>';
				endforeach;

				$html.=
				'<tr>
				<hr />
				<td colspan ="11" align="center">'.$_SESSION['nombre'].'</td>
				</tr>
          	</table>';
