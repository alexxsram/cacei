<?php
 class ProfesorMateria {
   public $materia;
   public $seccion;
   const TABLA = 'EA_PROFESOR_MATERIA';
    ...
    public function __construct($m, $s) {
      ...
      public static function buscarPorId($id){
          include ("conexion.php");
           $consulta = $base->prepare('SELECT fk_materia, seccion FROM ' . self::TABLA . ' WHERE nrc = :id');
    ...
    public static function recuperarTodos($id){
       ...
       */
       include ("conexion.php");
          $sql = "SELECT * FROM EA_PROFESOR_MATERIA WHERE fk_profesor =". $id;
